...
public class MainActivity extends AppCompatActivity {
    ...
    private void copyFilesFromRawToInternalStorage() {
        int[] rawResources = {R.raw.review, R.raw.booking, R.raw.salon, R.raw.user, R.raw.stylist, R.raw.schedule2, R.raw.schedule1, R.raw.schedule3, R.raw.dayschedule1}; // Raw resource IDs
        String[] fileNames = {"review.txt", "booking.txt", "salon.txt", "user.txt", "stylist.txt", "schedule2.txt", "schedule1.txt", "schedule3.txt", "dayschedule1.txt"}; // Internal file names
