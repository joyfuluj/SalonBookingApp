                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        try {
                                            ...
                                            while ((line3 = br3.readLine()) != null){
                                                ...
                                                if ( words3[3].equals("1") && words3[0].equals(day) && words3[1].equals(time)) {

                                                    Toast.makeText(TimeSlot.this, "Please cancel the bookings first", Toast.LENGTH_SHORT).show();
                                                    booked = true;
                                                    break;
                                                }
                                            }
